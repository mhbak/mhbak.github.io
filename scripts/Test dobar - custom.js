...
else if (((usercode==29876000&&passcode==33976800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='50')){scrollToAnchor('anchVrh'); goForit(loc,'UP')} /*ovo sa Gkk==50 je za seminare iz UP - vodi na BIMCO-vu web stranu */
...
function replaceBgRow3() {
  // $("#row3id").removeClass("row3");
  // $("#row3id").addClass("row3js");
  
    // $('.row3').css({'background': 'url(styles/images/wall/' + arguments[Math.floor(Math.random() * arguments.length)] + ') no-repeat center center' });
  // $('.row3').css('background-size','cover');
  
  // OVO JE OK:
  var imi = arguments;
  // setTimeout(function(){$('.row3').css({'background': 'url(styles/images/wall/' + imi[Math.floor(Math.random() * imi.length)] + ') no-repeat center center fixed' });
  // $('.row3').css('background-size','cover');}, 3000)
  
  // $('.row3').hide();
  // $('.row2').hide();
  $('.row3').css({'background': 'url(styles/images/wall/' + imi[Math.floor(Math.random() * imi.length)] + ') no-repeat center center' });
  $('.row3').css('background-size','cover');
  ...
  // $('.row3').css('visibility', 'visible').fadeIn(5000);
  // $('.row3').fadeIn(3000);
  // $('.slickm').fadeIn(3000);
  // $('.row2').fadeIn(3000);
  ...
  // OVO JE INTERESANTNO:
  // $('.row3').fadeTo('slow', 0.3, function(){$('.row3').css({'background': 'url(styles/images/wall/' + imi[Math.floor(Math.random() * imi.length)] + ') no-repeat center center fixed' });
  // $('.row3').css('background-size','cover');}).fadeTo('slow', 1);
  
  
  //https://forum.jquery.com/topic/style-backgroundimage-how-to-fade-it:
  
  // function replaceBgRow3() {
          // $('.row3').css({opacity: 0, backgroundImage: 'styles/images/wall/bg15.jpg'}).fadeTo(2000, 1.0);
    // }
  
  
  
  // setTimeout(function(){$('body').css('background-color','#232323')}, 6000)
  
  
  // $('body').css('background-color','#232323').fadeIn(3000);
    // alert(document.getElementById("row3id").className)
}

function replaceBgRow1() {
  // $('.row1').hide();
  $('.row1').css({'background': 'url(styles/images/wall/' + arguments[Math.floor(Math.random() * arguments.length)] + ') no-repeat center center' });
  $('.row1').css('background-size','cover');
  // $('.row1').fadeIn(5000);
}

function replaceBgRow7() {
  // $('.row7').hide();
  $('.row7').css({'background': 'url(styles/images/wall/' + arguments[Math.floor(Math.random() * arguments.length)] + ') no-repeat center center' });
