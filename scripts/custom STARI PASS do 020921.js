...
if( typeof Gk == 'undefined' ) {
	if (usercode==1480518&&passcode==29156519){chkOK("ORU")} // goForit(loc,'ORU')
	else if (usercode==1480518&&passcode==36472020){chkOK("ORUs")} // goForit(loc,'ORUs')
	else if (usercode==10976&&passcode==34361600){chkOK("PB")} // goForit(loc,'PB')	
	else if (usercode==1481088&&passcode==33929280){chkOK("TPR")} // goForit(loc,'TPR')	
	else if (usercode==1284192&&passcode==26738712){chkOK("PUB")} // goForit(loc,'PUB')
	else if (usercode==13104&&passcode==29876000){chkOK("UP")} //  goForit(loc,'UP')	
	else if (usercode==1454544&&passcode==39167856){chkOK("UOP")} // goForit(loc,'UOP')
	else if (usercode==1218336&&passcode==32003163){chkOK("OPB")} // goForit(loc,'OPB')	
	else if (usercode==1266035&&passcode==30232800){chkOK("SEM")} // goForit(loc,'SEM')	
	else if (usercode==1209600&&passcode==33771600){chkOK("DPL")} // goForit(loc,'DPL')
	else if (usercode==1415232&&passcode==40378800){chkOK("UPL")} // goForit(loc,'UPL')	
	else if (usercode==1320900&&passcode==28670096){chkOK("DOW")} // goForit(loc,'DOW') 
	else if (usercode==92236816&&passcode==92236816){chkOK("BAR")} // goForit(loc,'BAR') 
	/* else if ((usercode==1415232&&passcode==28670096) || (usercode==1266035&&passcode==1209600)){createCookie('ImeKuki','SEM',1);goForit(loc,'UPL')}
	else if ((usercode==1415232&&passcode==28670096) || (usercode==1209600&&passcode==30232800)){createCookie('ImeKuki','DPL',1);goForit(loc,'UPL')} */
	else{
...
if (((usercode==1480518&&passcode==29156519)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Oru')){scrollToAnchor('anchVrh'); goForit(loc,'ORU')}
else if (((usercode==1480518&&passcode==36472020)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Orus')){scrollToAnchor('anchVrh'); goForit(loc,'ORUs')}
else if (((usercode==10976&&passcode==34361600)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Pb')){scrollToAnchor('anchVrh'); goForit(loc,'PB')}
else if (((usercode==1481088&&passcode==33929280)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Tpr')){scrollToAnchor('anchVrh'); goForit(loc,'TPR')}
else if (((usercode==1284192&&passcode==26738712)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Pub')){scrollToAnchor('anchVrh'); goForit(loc,'PUB')}
else if (((usercode==13104&&passcode==29876000)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Up')){scrollToAnchor('anchVrh'); goForit(loc,'UP')}
else if (((usercode==1454544&&passcode==39167856)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Uop')){scrollToAnchor('anchVrh'); goForit(loc,'UOP')}
else if (((usercode==1218336&&passcode==32003163)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Opb')){scrollToAnchor('anchVrh'); goForit(loc,'OPB')}
else if (((usercode==1266035&&passcode==30232800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='20')){scrollToAnchor('anchVrh'); goForit(loc,'SEM')}
else if (((usercode==1209600&&passcode==33771600)||(usercode==92236816&&passcode==92236816))&&(Gkk=='10')){scrollToAnchor('anchVrh'); goForit(loc,'DPL')}
else if (((usercode==1415232&&passcode==40378800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){goForit(loc,'UPL')}
else if (((usercode==1320900&&passcode==28670096)||(usercode==92236816&&passcode==92236816))&&(Gkk=='30')){goForit(loc,'DOW')}
else if (((usercode==13104&&passcode==29876000)||(usercode==92236816&&passcode==92236816))&&(Gkk=='50')){scrollToAnchor('anchVrh'); goForit(loc,'UP')} /*ovo sa Gkk==50 je za seminare iz UP - vodi na BIMCO-vu web stranu */

else if (((usercode==1480518&&passcode==29156519)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','ORU')}
else if (((usercode==1480518&&passcode==36472020)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','ORUs')}
else if (((usercode==10976&&passcode==34361600)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','PB')}
else if (((usercode==1481088&&passcode==33929280)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','TPR')}
else if (((usercode==1284192&&passcode==26738712)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','PUB')}
else if (((usercode==13104&&passcode==29876000)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','UP')}
else if (((usercode==1454544&&passcode==39167856)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','UOP')}
else if (((usercode==1218336&&passcode==32003163)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','OPB')}
else if (((usercode==1266035&&passcode==30232800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','SEM')}
else if (((usercode==1209600&&passcode==33771600)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','DPL')}
/* else if ((usercode==1415232&&passcode==28670096) || (usercode==1266035&&passcode==1209600)){createCookie('ImeKuki','SEM',1);goForit(loc,'UPL')}
else if ((usercode==1415232&&passcode==28670096) || (usercode==1209600&&passcode==30232800)){createCookie('ImeKuki','DPL',1);goForit(loc,'UPL')} */
else{
document.getElementById("ok").setAttribute("class", "osx-err-hiden");
...
if (usercode==92236816){
	...
	createCookie(CookName,1,25) //name, value (1 - positive), days
}
	fetch(loc)
