...
if( typeof Gk == 'undefined' ) {
	if (usercode==29156519&&passcode==41849172){chkOK("ORU")} // goForit(loc,'ORU')
	else if (usercode==36472020&&passcode==35415930){chkOK("ORUs")} // goForit(loc,'ORUs')
	else if (usercode==34361600&&passcode==30293760){chkOK("PB")} // goForit(loc,'PB')	
	else if (usercode==33929280&&passcode==27315600){chkOK("TPR")} // goForit(loc,'TPR')	
	else if (usercode==26738712&&passcode==38524640){chkOK("PUB")} // goForit(loc,'PUB')
	else if (usercode==29876000&&passcode==32815800){chkOK("UP")} //  goForit(loc,'UP')	
	else if (usercode==39167856&&passcode==28408632){chkOK("UOP")} // goForit(loc,'UOP')
	else if (usercode==32003163&&passcode==33146355){chkOK("OPB")} // goForit(loc,'OPB')	
	else if (usercode==30232800&&passcode==31427463){chkOK("SEM")} // goForit(loc,'SEM')	
	else if (usercode==33771600&&passcode==28274400){chkOK("DPL")} // goForit(loc,'DPL')
	else if (usercode==40378800&&passcode==35224860){chkOK("UPL")} // goForit(loc,'UPL')	
	else if (usercode==28670096&&passcode==31416000){chkOK("DOW")} // goForit(loc,'DOW') 
...
if (((usercode==29156519&&passcode==41849172)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Oru')){scrollToAnchor('anchVrh'); goForit(loc,'ORU')}
else if (((usercode==36472020&&passcode==35415930)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Orus')){scrollToAnchor('anchVrh'); goForit(loc,'ORUs')}
else if (((usercode==34361600&&passcode==30293760)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Pb')){scrollToAnchor('anchVrh'); goForit(loc,'PB')}
else if (((usercode==33929280&&passcode==27315600)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Tpr')){scrollToAnchor('anchVrh'); goForit(loc,'TPR')}
else if (((usercode==26738712&&passcode==38524640)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Pub')){scrollToAnchor('anchVrh'); goForit(loc,'PUB')}
else if (((usercode==29876000&&passcode==32815800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Up')){scrollToAnchor('anchVrh'); goForit(loc,'UP')}
else if (((usercode==39167856&&passcode==28408632)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Uop')){scrollToAnchor('anchVrh'); goForit(loc,'UOP')}
else if (((usercode==32003163&&passcode==33146355)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Opb')){scrollToAnchor('anchVrh'); goForit(loc,'OPB')}
else if (((usercode==30232800&&passcode==31427463)||(usercode==92236816&&passcode==92236816))&&(Gkk=='20')){scrollToAnchor('anchVrh'); goForit(loc,'SEM')}
else if (((usercode==33771600&&passcode==28274400)||(usercode==92236816&&passcode==92236816))&&(Gkk=='10')){scrollToAnchor('anchVrh'); goForit(loc,'DPL')}
else if (((usercode==40378800&&passcode==35224860)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){goForit(loc,'UPL')}
else if (((usercode==28670096&&passcode==31416000)||(usercode==92236816&&passcode==92236816))&&(Gkk=='30')){goForit(loc,'DOW')}
else if (((usercode==29876000&&passcode==32815800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='50')){scrollToAnchor('anchVrh'); goForit(loc,'UP')} /*ovo sa Gkk==50 je za seminare iz UP - vodi na BIMCO-vu web stranu */

else if (((usercode==29156519&&passcode==41849172)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','ORU')}
else if (((usercode==36472020&&passcode==35415930)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','ORUs')}
else if (((usercode==34361600&&passcode==30293760)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','PB')}
else if (((usercode==33929280&&passcode==27315600)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','TPR')}
else if (((usercode==26738712&&passcode==38524640)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','PUB')}
else if (((usercode==29876000&&passcode==32815800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','UP')}
else if (((usercode==39167856&&passcode==28408632)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','UOP')}
else if (((usercode==32003163&&passcode==33146355)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','OPB')}
else if (((usercode==30232800&&passcode==31427463)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','SEM')}
else if (((usercode==33771600&&passcode==28274400)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','DPL')}
/* else if ((usercode==40378800&&passcode==31416000) || (usercode==30232800&&passcode==33771600)){createCookie('ImeKuki','SEM',1);goForit(loc,'UPL')}
else if ((usercode==40378800&&passcode==31416000) || (usercode==33771600&&passcode==31427463)){createCookie('ImeKuki','DPL',1);goForit(loc,'UPL')} */
else{
document.getElementById("ok").setAttribute("class", "osx-err-hiden");
